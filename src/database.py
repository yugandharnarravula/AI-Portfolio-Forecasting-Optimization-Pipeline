"""Database operations for saving portfolio optimisation results to Supabase.
Author: Yugandhar Narravula
"""
...
def save_results_to_supabase(result: dict[str, Any]) -> None:
    ...
    logger.info(f"Successfully saved {len(rows)} portfolio predictions to Supabase")
